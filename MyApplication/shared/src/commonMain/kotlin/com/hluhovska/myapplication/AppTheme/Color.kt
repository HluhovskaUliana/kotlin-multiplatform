...
// Кольори для Світлої теми (Light)
...
// Кольори для Темної теми (Dark)
val md_theme_dark_primary = Color(0xFF82D3E1)
...
val md_theme_dark_tertiaryContainer = Color(0xFF3B4764)
...
val md_theme_dark_onSurfaceVariant = Color(0xFFDBE4E6)
